...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kenny.Services.ShoppingCartAPI.Models.CartDetails", b =>
                {
            ...
            modelBuilder.Entity("Kenny.Services.ShoppingCartAPI.Models.CartHeader", b =>
                {
                    b.Property<int>("CartHeaderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Kenny.Services.ShoppingCartAPI.Models.CartDetails", b =>
                {
                    b.HasOne("Kenny.Services.ShoppingCartAPI.Models.CartHeader", "CartHeader")
                        .WithMany()
                        .HasForeignKey("CartHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Kenny.Services.ShoppingCartAPI.Models.Product", "Product")
                        .WithMany()
